...
$classes = Join-Path $WorkingDirectory 'universe-loader-classes'
...
$result = Invoke-InformationalNativeCommand $tools['java.exe'] @('-Xmx4g','-cp',$classes,'com.vistance.bo.routeb.UniverseLoaderProbe',$SapInstallRoot,$IdtPluginDirectory,$OutputDirectory) 'UNIVERSE_LOADER_DISCOVERY_FAILURE'
